...
Route::group(['prefix' => 'setting/',                                   'as' => 'setting',                                      'namespace' => 'Setting\\'], function () {
    ...
    //Route::get('online-registration/{id}/remove-program', ['as' => '.online-registration.remove-program',                                                                       'uses' => 'OnlineRegistrationSettingController@removeProgram']);
...
/*EduFirm Super Suit Grouping - user activity, database backup, cronjob*/
