                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a class="green" href="{{ route($base_route.'.view', ['id' => encrypt($row->id)]) }}">
                                            <i class="ace-icon fa fa-eye bigger-130"></i>
                                        </a>

                                        <a class="green" href="{{ route($base_route.'.edit', ['id' => encrypt($row->id)]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>

                                        <a href="{{ route($base_route.'.delete', ['id' => encrypt($row->id)]) }}" class="red bootbox-confirm">
