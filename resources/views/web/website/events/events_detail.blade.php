                    ...
                    <aside class="sidebar right-sidebar">
                        ...
                        <div class="sidebar-widget categories-blog">
                            <div class="sidebar-title">
                                <h2>Latest {{isset($data['home_setting']->event_title)?$data['home_setting']->event_title:'Events'}}</h2>
                                <div class="separator">
                                    <span class="dott"></span>
                                    <span class="dott"></span>
                                    <span class="dott"></span>
                                ...
                                <ul class="list">
                                    @if (isset($data['recent']) && $data['recent']->count() > 0)
                                        @foreach($data['recent'] as $row)
                                            <li>
                                                <a href="{{ route('web.events').'/'.$row->slug }}">{{ $row->title }}</a>
                                            </li>
                                        @endforeach
                                        <a class="pull-right" href="{{route('web.events')}}">More {{isset($data['home_setting']->event_title)?$data['home_setting']->event_title:'Events'}}...</a>
                                    @else
                                        <li>
                                            <a href="#">....</a>
                                        </li>
