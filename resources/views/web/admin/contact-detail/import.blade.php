                ...
                <div class="col-xs-12">
                    ...
                    <div class="easy-link-menu align-right">
                        <a href="{{ route($base_route) }}" class="btn btn-xs btn-primary">
                            <i class="icon-list bigger-120"></i>&nbsp;All {{ $panel }}
                        </a>
                    </div>
                    <hr class="hr-double">
                    <div class="row">
                        ...
                        <div class="form-horizontal">
                            ...
                            <hr>
                            <a href="{{ asset('assets/csv-template/contact-import.csv') }}" target="_blank" class="easy-link-menu"><h3><i class="fa fa-download"></i> CSV Template for Bulk {{$panel}} Import</h3></a>
                            <hr>
