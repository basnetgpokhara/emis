                    ...
                    @if (isset($data['rows']) && $data['rows']->count() > 0)
                        ...
                        @foreach($data['rows'] as $row)
                            <tr>
                                ...
                                <td>
                                    <div class=" btn-group">
                                        <a href="{{route('web.blog').'/'.$row->slug }}" class="btn btn-xs btn-primary" target="_blank">
                                            <i class="ace-icon fa fa-globe"></i>
                                        </a>
                                        <a href="{{ route('web.admin.info.smsemail.subscriber-blog-notification', ['id' => encrypt($row->id)]) }}" class="btn btn-xs btn-warning">
