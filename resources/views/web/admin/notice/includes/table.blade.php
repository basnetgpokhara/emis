                ...
                @if (isset($data['rows']) && $data['rows']->count() > 0)
                    ...
                    @foreach($data['rows'] as $row)
                        <tr>
                                        ...
                                        <div class="panel-heading">
                                            <a href="#{{$row->id}}" data-parent="#faq-list-4" data-toggle="collapse" class="accordion-toggle collapsed">
                                                ...
                                                <span class="label label-sm label-primary">
                                                    Publish On - {{ date('jS M, Y', strtotime($row->publish_date)) }}
                                                </span>
                                                <span class="label label-sm label-primary">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('web.notice').'/'.$row->slug }}" class="btn btn-xs btn-primary" target="_blank">
                                        <i class="ace-icon fa fa-globe"></i>
                                    </a>
                                    <a href="{{ route('web.admin.info.smsemail.subscriber-notice-notification', ['id' => encrypt($row->id)]) }}" class="btn btn-xs btn-warning">
