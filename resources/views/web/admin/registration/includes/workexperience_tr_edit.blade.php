@if(isset($workExperiences) && $workExperiences->count() > 0)
    @foreach($workExperiences as $workExperience)
        <tr class="option_value">
            ...
            <td width="5%">
                <div class="btn-group">
                    <a href="{{ route('web.admin.registration.delete-workExperience', ['id' => $workExperience->id]) }}" class="btn btn-primary btn-minier btn-danger bootbox-confirm align-right" >
