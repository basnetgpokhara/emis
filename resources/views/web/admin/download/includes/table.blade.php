                    ...
                    @if (isset($data['rows']) && $data['rows']->count() > 0)
                        ...
                        @foreach($data['rows'] as $row)
                            <tr>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-collapse collapse" id="{{$row->id}}" style="height: 0px;">
                                                <div class="panel-body">
                                                    @if ($row->file)
                                                        <a href="{{ asset('web/'.$folder_name.'/'.$row->file) }}" target="_blank"><i class="icon-download"></i>  {{ $row->title }}</a>
                                                    @else
                                                        <p>No File</p>
                                                    @endif
                                                    <hr class="hr-2">
                                ...
                                <td>
                                    <div class=" btn-group">
                                        <a href="{{ asset('web/'.$folder_name.'/'.$row->file) }}" class="btn btn-xs btn-primary" target="_blank">
