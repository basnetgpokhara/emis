                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li>
                                                                                <a href="{{ route($base_route.'.option.active', ['id' => encrypt($option->id)]) }}" title="Active"><i class="fa fa-check" aria-hidden="true"></i> Active</a>
                                                                            </li>

                                                                            <li>
                                                                                <a href="{{ route($base_route.'.option.in-active', ['id' => encrypt($option->id)]) }}" title="In-Active"><i class="fa fa-remove" aria-hidden="true"></i> In-Active</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
