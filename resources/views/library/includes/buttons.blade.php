<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-right">
        ...
        <a class="{!! request()->is('library/request-student*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('library.student-request') }}"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;Student Request</a>
        <a class="{!! request()->is('library/request-staff*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('library.staff-request') }}"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;Staff Request</a>
