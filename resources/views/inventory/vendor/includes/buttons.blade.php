<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-left ">
        ...
        <a class="{!! request()->is('inventory/vendor/registration*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('inventory.vendor.registration') }}"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Registration</a>
        <a class="{!! request()->is('inventory/vendor/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('inventory.vendor.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Bulk Registration</a>
