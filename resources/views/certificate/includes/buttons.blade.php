<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-right">
        ...
        <a class="{!! request()->is('certificate/nirgam-utara*')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('certificate.nirgam-utara') }}"><i class="fa fa-list" aria-hidden="true"></i> Nirgam Utara</a>
