                        ...
                        <table id="" class="table table-striped table-bordered table-hover">
                            ...
                            @if (isset($data['student']) && $data['student']->count() > 0)
                                ...
                                @foreach($data['student'] as $student)
                                    ...
                                    <tr>
                                        <th>Leave Time Class</th>
                                        <td>{{$student->leaving_time_class}}</td>
                                    </tr>

                                    <tr>
                                        <th>Paid Fee Status</th>
                                        <td>{{$student->paid_fee_status}}</td>
                                    </tr>

                                    <tr>
                                        <th>Qualified To Promote</th>
                                        <td>{{$student->qualified_to_promote}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>History</th>
                                        <td>
                                            @php($history = $student->certificateHistory->where('certificate','transfer')->where('certificate_id',$student->certificate_id))
