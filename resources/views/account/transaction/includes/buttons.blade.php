<div class="clearfix hidden-print ">
    <div class="">
        ...
        <a class="{!! request()->is('account/transaction/multi-add')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('account.transaction.multi-add') }}"><i class="fa fa-plus" aria-hidden="true"></i> Multi Adjustment Transaction</a>
