...
{!! Form::open(['route' => 'print-out.exam.mark-sheet', 'id' => 'print-student-marksheet']) !!}
    ...
    <div class="clearfix">
        <label class="pos-rel">
            ...
            <span class="lbl"></span> Report Card-Grading(6-10)
        </label>
        <label class="pos-rel">
            <!--<input type="radio" name="result-type" value="percentage" id="typePercentage" class="ace" />
            <span class="lbl"></span> Percentage-->
			 <input type="radio" name="result-type" value="cas_grading" id="typeGradingSecondary" class="ace"/>
            <span class="lbl"></span> Report Card-CAS(Nur-5)
        </label>
        
        <label class="pos-rel">
            <input type="radio" name="result-type" value="ledger" id="typeLedger" class="ace" />
            <span class="lbl"></span> GradeLedger(6-10)
        </label>
        <label class="pos-rel">
            <input type="radio" name="result-type" value="gradeledger" id="gradetypeLedger" class="ace"/>
            <span class="lbl"></span> GradeLedger(Nur-5)
        </label>
