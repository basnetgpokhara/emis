<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-left">
        ...
        <a class="{!! request()->is('setting/online-registration')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.online-registration') }}"><i class="fa fa-archive" aria-hidden="true"></i>&nbsp;Online Registration</a>
