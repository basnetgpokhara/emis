<div class="row">
    ...
    <div class="col-xs-12 col-sm-9 col-print-9">
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                @if($data['student']->national_id_type && $data['student']->national_id_number)
                    <div class="profile-info-name"> {{$data['student']->national_id_type}} : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="national_id_number">{{ $data['student']->national_id_number }}</span>
                    </div>
                @endif

                @if($data['student']->extra_id_card_type && $data['student']->extra_id_card_number)
                    <div class="profile-info-name"> {{$data['student']->extra_id_card_type}} : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="extra_id_card_number">{{ $data['student']->extra_id_card_number }}</span>
                    </div>
                @endif
            </div>
