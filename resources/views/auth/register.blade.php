...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                <label for="password-confirm" class="form-label fw-bold text-muted small">Confirm Password</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
            ...
            <div class="text-center mt-4">
                ...
                <a href="{{ route('login') }}" class="text-decoration-none small fw-bold ms-1" style="color: var(--primary);">
                    Sign In
                </a>
            </div>
        </form>
