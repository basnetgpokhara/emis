                            ...
                            <div class="tabbable  ">
                                    ...
                                    <div class="tab-content no-border padding-24">
                                        <div id="profile" class="tab-pane in active">
                                            ...
                                            @include('user-student-online-registration.detail.includes.profile')
                                        </div><!-- /#home -->

                                        <div id="academicInfo" class="tab-pane">
                                            @include('user-student-online-registration.detail.includes.academicInfo')
                                        </div><!-- /#AcademicInfo -->

                                        <div id="documents" class="tab-pane">
                                            @include('user-student-online-registration.detail.includes.documents')
                                        </div><!-- /#Documents -->

                                        <div id="notes" class="tab-pane">
                                            @include('user-student-online-registration.detail.includes.notes')
                                        </div><!-- /#Notes -->

                                        <div id="login-access" class="tab-pane">
                                            @include('user-student-online-registration.detail.includes.login-access')
                                        </div><!-- /#Login Detail -->
