                ...
                <div class="row">
                    ...
                    @include('includes.validation_error_messages')
                        <div class="align-right hidden-print">
                            <a class="btn-primary btn-sm" href="{{ route('user-student.profile') }}"  >
                                <i class="ace-icon fa fa-eye"></i> View Profile
                            </a>
                        </div>
                        {!! Form::model($data['row'], ['route' => ['user-student.profile.update', encrypt($data['row']->id)], 'method' => 'POST', 'class' => 'form-horizontal',
...
@section('js')
    ...
    @include('user-student-online-registration.registration.includes.student-comman-script')
