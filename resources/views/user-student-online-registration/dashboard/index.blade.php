    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                @include('user-student-online-registration.layouts.includes.template_setting')
                ...
                <div class="row">
                    <div class="col-xs-12 ">
                        ...
                        @include('user-student-online-registration.dashboard.includes.notice')
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                           {{-- <div class="col-sm-12 align-right hidden-print">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <div class="label {{ $data['student']->status == 'active'?"label-success":"label-warning" }} label-xlg arrowed-in arrowed-right arrowed">
                                        {{ $data['student']->status == 'active'?"Verified":"Un Verified" }}
                                </div>
                                <div class="space-6"></div>
