                                        ...
                                        <div class="widget-box transparent ">
                                                ...
                                                <div class="col-md-10 col-print-10 align-right">
                                                    <div class="text-center">
                                                        ...
                                                        <h2 class="no-margin text-uppercase" style="font-family: 'Black Ops One', cursive;font-size: 30px">
                                                            <strong><u>MARK - SHEET/GRADE - SHEET</u></strong>
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table width="100%" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <!--<th colspan="3" class="text-center">OBTAINED MARKS MARKS</th>-->
                                                    ...
                                                    @if($student->subjects && $student->subjects->count() > 0)
                                                        ...
                                                        @foreach($student->subjects as $subject)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!--<td class="text-center">{{$subject->full_mark_theory?$subject->full_mark_theory:'-'}}</td>-->
                                                                <!--<td class="text-center">{{$subject->full_mark_practical?$subject->full_mark_practical:'-'}}</td>-->
                                                                <!--<td class="text-center">{{$subject->pass_mark_theory?$subject->pass_mark_theory:'-'}}</td>-->
                                                                <!--<td class="text-center">{{$subject->pass_mark_practical?$subject->pass_mark_practical:'-'}}</td>-->
                                                                <!--<td class="text-center">{{$subject->obtain_mark_theory?$subject->obtain_mark_theory.$subject->th_remark:'-'}}</td>-->
                                                                <!--<td class="text-center">{{$subject->obtain_mark_practical?$subject->obtain_mark_practical.$subject->pr_remark:'-'}}</td>-->
                                                                
                                                               <!-- <td>{{$subject->total_obtain_mark?$subject->obtain_mark_theory+obain_mark_practical.$subject->pr_remark:'-'}}</td>-->
                                                               
                                                                       <!--<td>{{$subject->obtain_mark_practical?$subject->obtain_mark_theory + $subject->obtain_mark_theory:'-'}}</td> -->
                                                                       
                                                                   <!--@if($subject->full_mark_practical > 0)
                                                                                @if($subject->pr_remark <>'-')
                                                                                <td>{{$subject->obtain_mark_theory + $subject->obtain_mark_practical}}</td>
                                                                    ...
                                                                    <!--@if($subject->full_mark_practical > 0 && $subject->pr_remark <>'-')
                                                                            <td>{{$subject->obtain_mark_theory + $subject->obtain_mark_practical}}</td>
                                                                            @else
                                                                            <td>{{$subject->obtain_mark_theory}}</td>
                                                                            @endif-->
                                                ...
                                                <table width="100%" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="5" class="text-center">GRADE POINT AVERAGE</th>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <tr>
                                                            <td class="text-center"> {{isset($student->gpa_average)?$student->gpa_average:''}}</td>
                                                            @if($student->gpa_average>=3.6)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'A+':'' }}</td>
                                                            @elseif($student->gpa_average>=3.2)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'A':'' }}</td>
                                                                @elseif($student->gpa_average>=2.8)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'B+':'' }}</td>
                                                                @elseif($student->gpa_average>=2.4)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'B':'' }}</td>
                                                                @elseif($student->gpa_average>=2.0)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'C+':'' }}</td>
                                                                @elseif($student->gpa_average>=1.6)
                                                                <td class="text-center">{{ isset($student->gpa_grade)?'C':'' }}</td>
                                                           @endif
                                                            
                                                          
                                                            <!--<td class="text-center">{{number_format((float)$student->percentage, 2, '.', '').'%'}}</td>
                                                            <td class="text-center">Rank: {{-- ViewHelper::getStudentRankingInExam($data['year'], $data['month'], $data['exam'],$data['faculty'], $data['semester'], $student->id) --}}
                                                                {{$student->rank}}</td>-->
                                                                <td class="text-center">{{isset($student->remark)?$student->remark:''}}</td>
                                                                </tr>
                                                                 
                                                </table>
                                            </div>
                                            <?php /*<div class="smaller-80">
                                                <span>
                                            ...
                                            <div class="table-responsive">
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong style="border-top:1px black solid;"></strong></td>
                                                        <td class="text-right"><strong style="border-top:1px black solid;">Principal</strong></td>
                                                    </tr>
                                                    <tr>
