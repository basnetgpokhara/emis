    ...
    public function run()
    {
        DB::table('alert_settings')->insert([
            ...
            [
                ...
                'template' => 'Dear {{first_name}}, you are successfully registered in our institution with RegNo.{{reg_no}}. Your login password is {{password}} ,Thank You.',
                'status' => 1
            ],
            [
                'created_at' => \Carbon\Carbon::now(),
            ...
            [
                ...
                'updated_at' => \Carbon\Carbon::now(),
                'created_by' => 1,
                'event' => 'MeetingScheduleInvitation',
                'sms' => 0,
                'email' => 0,
                'subject' =>'Meeting Scheduled Invitation',
                'template' => 'Dear {{first_name}}, {{semester}}/{{subject}}/{{topic}} Meeting Scheduled @{{start_time}}. Please Present on Time And Connect. Thank you',
                'status' => 1
            ],
            [
                'created_at' => \Carbon\Carbon::now(),
                ...
                'sms' => 0,
                'email' => 0,
                'subject' =>'Meeting Start Join Request',
                'template' => 'Dear {{first_name}}, {{semester}}/{{subject}}/{{topic}} Meeting Started, Please Connect to Attend Class. Thank you',
                'status' => 1
            ],
            [
                'created_at' => \Carbon\Carbon::now(),
                ...
                'template' => 'Dear {{name}}, your application successfully registered with Reg. No.{{reg_no}}. Thank You.',
                'status' => 1
            ],
            [
                'created_at' => \Carbon\Carbon::now(),
                'updated_at' => \Carbon\Carbon::now(),
                'created_by' => 1,
                'event' => 'Web Registration Approve',
                'sms' => 0,
                'email' => 0,
                'subject' =>'Registration Approve',
                'template' => 'Dear {{name}}, your Reg. No.{{reg_no}} application successfully approved. Thank You.',
                'status' => 1
            ],
            [
                'created_at' => \Carbon\Carbon::now(),
                'updated_at' => \Carbon\Carbon::now(),
                'created_by' => 1,
                'event' => 'Web Registration Reject',
                'sms' => 0,
                'email' => 0,
                'subject' =>'Registration Reject',
                'template' => 'Dear {{name}}, your Reg. No.{{reg_no}} application rejected. Thank You.',
                'status' => 1
            ],
        ]);
    }
