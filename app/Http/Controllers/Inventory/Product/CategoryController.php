...
use App\Http\Requests\Inventory\Product\Category\AddValidation;
use App\Http\Requests\Inventory\Product\Category\EditValidation;
use App\Models\SubCategory;
use App\Models\Category;
use Illuminate\Http\Request;
class CategoryController extends CollegeBaseController
{
    protected $base_route = 'inventory.product.category';
    protected $view_path = 'inventory.product.category';
