...
use App\Http\Requests\Inventory\Customer\Registration\AddValidation;
use App\Http\Requests\Inventory\Customer\Registration\EditValidation;
...
{
    protected $base_route = 'inventory.customer';
    protected $view_path = 'inventory.customer';
