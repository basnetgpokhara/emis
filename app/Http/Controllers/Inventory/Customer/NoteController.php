...
use App\Http\Requests\Inventory\Customer\Notes\AddValidation;
use App\Http\Requests\Inventory\Customer\Notes\EditValidation;
use App\Models\Note;
...
{
    protected $base_route = 'inventory.customer.note';
    protected $view_path = 'inventory.customer.note';
