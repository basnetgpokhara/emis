...
use App\Http\Requests\Inventory\Vendor\Registration\AddValidation;
use App\Http\Requests\Inventory\Vendor\Registration\EditValidation;
...
{
    protected $base_route = 'inventory.vendor';
    protected $view_path = 'inventory.vendor';
