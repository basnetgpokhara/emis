...
use App\Http\Requests\Inventory\Vendor\Notes\AddValidation;
use App\Http\Requests\Inventory\Vendor\Notes\EditValidation;
use App\Models\Note;
...
{
    protected $base_route = 'inventory.vendor.note';
    protected $view_path = 'inventory.vendor.note';
