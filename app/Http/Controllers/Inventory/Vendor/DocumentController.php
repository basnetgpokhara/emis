...
namespace App\Http\Controllers\Inventory\Vendor;

use App\Http\Controllers\CollegeBaseController;
use App\Http\Requests\Inventory\Vendor\Document\AddValidation;
use App\Http\Requests\Inventory\Vendor\Document\EditValidation;
...
{
    protected $base_route = 'inventory.vendor.document';
    protected $view_path = 'inventory.vendor.document';
