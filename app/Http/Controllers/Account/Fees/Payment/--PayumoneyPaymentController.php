...
class PayumoneyPaymentController extends CollegeBaseController
{
    ...
    public function payumoneyPaymentSuccess(Request $request)
    {
        ...
        dd($request->all());
        /*
         *  "_token" => "ZoFJxxiPk02w2uHoSVwuzG4NLMFbtROVWElHV0Ty"
  "student_id" => "23"
  "reg_no" => "0010780107"
  "net_balance" => "15000"
  "description" => "{"0":{"id":23,"reg_no":"0010780107","reg_date":"2021-04-26 00:00:00","first_name":"UMESH","middle_name":"KUMAR","last_name":"YADAV","faculty":1,"semester":1,"date_of_birth":"2021-04-26 00:00:00","email":"freelancerumeshnepal@gmail.com","mobile_1":"9868156047","father_first_name":"STOCK","father_middle_name":"ENTRY","father_last_name":"SUPPLIER","student_image":null,"status":"active","payment_today":0,"fee_amount":"15000","discount":0,"fine":0,"paid_amount":0,"balance":15000,"currentURL":"http:\/\/127.0.0.1:8000\/user-student\/fees"},"user_id":5}
         * */
