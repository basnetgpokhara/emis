...
class ZoomMeetingController extends CollegeBaseController
{
    ...
    public function zoomIndex(Request $request)
    {
        ...
        $zoomMeetings = Zoom::user()->find($meetingSetting['Email'])->meetings()->all();
        $data['meetings'] = $zoomMeetings->sortByDesc('start_time');
    ...
    public function store(AddValidation $request)
    {
        ...
        $user = Zoom::user()->find($meetingSetting['Email']);
    ...
    public function delete(Request $request, $id)
    {
        ...
        $zoomMeeting = Zoom::meeting()->find($row->meeting_id);
