...
use App\Http\Requests\Academic\Month\AddValidation;
use App\Http\Requests\Academic\Month\EditValidation;
use App\Models\Month;
use Illuminate\Http\Request;

class MonthsController extends CollegeBaseController
{
    protected $base_route = 'month';
    protected $view_path = 'academic.month';
    protected $panel = 'Months';
