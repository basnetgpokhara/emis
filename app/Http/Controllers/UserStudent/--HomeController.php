...
class HomeController extends CollegeBaseController
{
    ...
    protected $online_registration_view_path = 'user-student-online-registration';
    protected $panel = 'Dashboard';
    protected $folder_path;
    protected $folder_name = 'studentProfile';
    protected $filter_query = [];
    protected $onlineRegistrationStudentStatusCode = 8;
    ...
    public function index()
    {
        ...
        if($data['student']->academic_status == $this->onlineRegistrationStudentStatusCode){
            return view(parent::loadDataToView($this->online_registration_view_path.'.dashboard.index'), compact('data'));
        }else{
    ...
    public function profile()
    {
        ...
        if($data['student']->academic_status == $this->onlineRegistrationStudentStatusCode){
            return view(parent::loadDataToView($this->online_registration_view_path.'.detail.index'), compact('data'));
        }else{
    ...
    public function editProfile(Request $request, $id)
    {
        ...
        if($data['student']->academic_status == $this->onlineRegistrationStudentStatusCode){
            return view(parent::loadDataToView($this->online_registration_view_path.'.registration.edit'), compact('data'));
        }else{
    ...
    public function fees()
    {
        ...
        if($data['student']->academic_status == $this->onlineRegistrationStudentStatusCode){
            return view(parent::loadDataToView($this->online_registration_view_path.'.fees.index'), compact('data'));
        }else{
    ...
    public function library()
    {
        ...
        if(isset($data['student']) && $data['student']->academic_status != $this->onlineRegistrationStudentStatusCode){
            return back();
        }else{
