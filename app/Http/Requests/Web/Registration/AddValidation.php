...
class AddValidation extends FormRequest
{
    ...
    {
        return [
            'reg_no'                        => 'max:50 | unique:web_registrations,reg_no',
            'reg_date'                      => 'required',
            ...
            'cell_1'                        => 'max:15',
            'cell_2'                        => 'max:15',
            'email'                         => 'unique:web_registrations,email',

            'mailing_address'               => 'max:100',
            'mailing_tel'                   => 'max:15',
            ...
            'guardian_signature_main_image'  => 'mimes:jpeg,bmp,png',
